  ...
  useEffect(() => {
    ...
    const fetchIdeas = async () => {
      ...
      try {
        ...
        // Burada geçmiş fikirler için filtreleme yapılabilir, ör: onaylanan, reddedilen, tamamlanan vs.
        const historyIdeas = allIdeas.filter((idea) => idea.createdBy === user.userName);
        setIdeas(historyIdeas);
      } catch {
  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col items-center w-full max-w-2xl mx-auto py-10">
        <h2 className="text-2xl font-bold mb-6 text-blue-800 text-center w-full">Geçmiş Fikirlerim</h2>
        ...
        {!loading && !error && ideas.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h3 className="text-xl font-semibold text-blue-800 mb-2">Daha önce hiç fikriniz yok</h3>
            <p className="text-gray-600 mb-6 text-center max-w-xs">Geçmişte hiç fikir eklemediniz. Hemen yeni bir proje veya fikir oluşturmak ister misiniz?</p>
            <button
